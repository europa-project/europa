...
bech32_templates = [
  ...
  ('era',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('era',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('era',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tera',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tera',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tera',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rera',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rera',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rera', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tera',  17, 32, False, False, False),
  ('rera',  3,  1, False, False, False),
  ('era',   15, 41, False, False, False),
  ('tera',  0, 16, False, False, False),
  ('rera',  0, 32, True,  False, False),
  ('era',   0, 16, True,  False, False),
  ('tera',  0, 32, False, True,  False),
  ('rera',  0, 20, False, False, True)
]
