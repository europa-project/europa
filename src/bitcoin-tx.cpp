...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " europa-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  europa-tx [options] <hex-tx> [commands]  Update hex-encoded europa transaction\n" +
            "or:     europa-tx [options] -create [commands]   Create hex-encoded europa transaction\n" +
            "\n";
