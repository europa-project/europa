...
const char * const BITCOIN_CONF_FILENAME = "europa.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Europa";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Europa";
#else
    // Unix
    return pathRet / ".europa";
#endif
#endif
}
