...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Europa Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Europa Core"
...
#define PACKAGE_BUGREPORT "https://github.com/europa-project/europa/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Europa Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Europa Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "europa"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://europa.org/"
