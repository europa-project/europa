# Support for Output Descriptors in Europa Core

Since Europa Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `era1...` for mainnet or `tera1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Europa's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Europa Core wallets, a convenience function `combo` is
